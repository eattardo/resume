...
- Implemented fast and reliable solvers integrated into the [MICENEA](http://www.medphys.it/res_micenea.htm) project
...
- Lead computational researcher on [RADIODRY](https://www.mesap.it/progetti/radiodry/) industrial project
...
- Member of the [Bioimpedance Research Group](https://bioimpedance.engineering.dartmouth.edu/people.html)
...
- **ATTARDO E.A.**, JAKOBUS U., BINGLE M., VAN TONDER J. (2019) – [Auxiliary Space-based Preconditioner for High Order Finite Element Method](https://ieeexplore.ieee.org/abstract/document/8888806), IEEE APS/URSI Atlanta

[Full publication list: 30+ papers available at [📎](assets/Attardo-Publications.pdf)]
